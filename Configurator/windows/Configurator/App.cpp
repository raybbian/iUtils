...
void App::OnLaunched(activation::LaunchActivatedEventArgs const& e)
{
    ...
    //set window size to fixed value
    ApplicationView::GetForCurrentView().SetPreferredMinSize({299, 399});
    ApplicationView::PreferredLaunchViewSize({300, 400});
    ApplicationView::PreferredLaunchWindowingMode(ApplicationViewWindowingMode::PreferredLaunchViewSize);
    Window::Current().CoreWindow().SizeChanged([&](CoreWindow const&, WindowSizeChangedEventArgs const& args) -> void {
        ApplicationView::GetForCurrentView().TryResizeView({300, 400});
	});
