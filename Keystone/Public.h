...
typedef enum {
	APPLE_INTERFACE_UNKNOWN,
	APPLE_INTERFACE_PTP,
	APPLE_INTERFACE_USB_MUX,
	APPLE_INTERFACE_CDC_NCM, //CONTROL INTF ONLY
	APPLE_INTERFACE_VALERIA
} APPLE_INTERFACE_TYPE, * PAPPLE_INTERFACE_TYPE;